...
export default function Layout({ children, isHome }: LayoutProps) {
  ...
  return (
    <div className="w-full min-h-screen grid grid-cols-10">
      ...
      <div className="flex flex-col gap-3 border-r   p-1 px py-3 box-border items-center dark:border-r-[#181818]">
        <svg
          viewBox="0 0 24 24"
        ...
        <IoLogOut onClick={handleLogout} className="w-8 h-8 cursor-pointer" />
      </div>
